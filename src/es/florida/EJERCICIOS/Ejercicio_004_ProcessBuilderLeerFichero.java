...
public class Ejercicio_004_ProcessBuilderLeerFichero {
	...
	public static void main(String[] args) {
		Ejercicio_004_ProcessBuilderLeerFichero ej = new Ejercicio_004_ProcessBuilderLeerFichero();
		ej.lanzarEjercicio_003(1, 10, "resultadoSuma.txt");
